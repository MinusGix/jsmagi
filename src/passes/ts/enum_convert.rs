...
fn visit_stmt(random_name: &RandomName, stmt: &Stmt) -> Option<Vec<Stmt>> {
    ...
    for stmt in &body.stmts {
        ...
        // "B"
        let Lit::Str(right_str) = assign.right.as_lit()? else { return None };
        ...
        let Lit::Num(init) = init else { return None; };
...
test!(
    ...
    enum_convert,
    enum_convert3,
    "(function(e1) { e1[e1.A = 0] = \"A\"; })(p = exports.Thing || (exports.Thing = {}));",
    "exports.Thing = exports.Thing || {}; p = exports.Thing; enum Thing { A = 0 }\n Object.assign(exports.Thing, Thing);"
);
...
test!(
    ...
    "(function (e1) { e1[e1.A = 1] = \"A\"; e1[e1.B = 2] = \"B\"; })(w || (w = {}));",
    // TODO: it might be nice to have the enum name be related to the variable name, like w_$000
